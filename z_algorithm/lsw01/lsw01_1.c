...
//第m行不动
		for(i=m+1 ;i<N;i++)
		{
			for(j=2*N-1 ;j>=m;j--){b[i][j]=-b[i][m]*b[m][j]/b[m][m]+b[i][j]; }
		}
...
for(i=0;i<N;i++)
for(j=N;j<2*N;j++)
{b[i][j].aa=0;b[i][j].bb=1;}
for(i=0;i<N;i++)
{b[i][N+i].aa=1;b[i][N+i].bb=1;}
...
{	char menu;long n;
	...
	while((menu=getchar())!='q')
	{
		switch(menu)
		{
		case '1' :hilb_1(4);break;system("pause");system("cls");printmenu();
		case '2' :printf("矩阵的阶数 n=");scanf("%d",&n);if(n<1||n>20){printf("1<=n&&n<=20");break;}
                  hilb_1(n);system("pause");system("cls");printmenu();break;
		case '3' : hilb_2(4);system("pause");system("cls");printmenu();break;
		case '4' :printf("矩阵的阶数 n=");scanf("%d",&n);if(n<1||n>20){printf("1<=n&&n<=20");break;}
                  hilb_2(n);system("pause");system("cls");printmenu();break;
		case '5' :hilb2(4,2);system("pause");system("cls");printmenu();break;
		case '6' :hilb2(4,1);system("pause");system("cls");printmenu();break;
		case '7' :qiuni(4,1);system("pause");system("cls");printmenu();break;
		case '8' :qiuni2(4);system("pause");system("cls");printmenu();break;
		case '9' :qiuni2(6);system("pause");system("cls");printmenu();break;
		case 'a' :printf("矩阵的阶数 n=");scanf("%d",&n);if(n<1||n>20){printf("1<=n&&n<=20");break;}
                  qiuni(n,2);system("pause");system("cls");printmenu();break;
		case 'b' :printf("矩阵的阶数 n=");scanf("%d",&n);if(n<1||n>20){printf("1<=n&&n<=20");break;}
                  qiuni2(n);system("pause");system("cls");printmenu();break;
		}
	}
	return 0;
}
